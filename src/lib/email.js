...
export const createAuthEmail = (code) => {
  ...
  const body = `
    ...
    <a href="${host}/?code=${code}" style="text-decoration: none; max-width: 400px; width: 100%; text-align:center; display:block; margin: 0 auto; margin-top: 1rem; background: #343a40; padding-top: 1rem; color: white; font-size: 1.25rem; padding-bottom: 1rem; font-weight: 600; border-radius: 4px;">계속하기</a>
  `;
  //TODO: 이메일 인증 API 구현 후, url 수정
